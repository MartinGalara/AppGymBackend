...
// postgresql://postgres:wMWaUMp4HWVMHBLhx1TZ@containers-us-west-117.railway.app:7141/railway
let sequelize = process.env.NODE_ENV === 'production'
  ? new Sequelize('postgresql://postgres:wMWaUMp4HWVMHBLhx1TZ@containers-us-west-117.railway.app:7141/railway') 
