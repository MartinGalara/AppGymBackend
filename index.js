...
conn.sync({ force: true }).then(() => {
  server.listen(PORT, () => {
    ...
    const users = [
      ...
      {name: "Testing", email: "aaronfrago@hotmail.com", hashPassword: "$2b$08$GgPmXQW77Z0AmWTKKN9T.ekHgjq/oVKWiqLtSvrM8AmLlJ3FUIify",role: "User"},    //auth0|636d38848ad399282c11fafa
    ]
