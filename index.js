...
conn.sync({ force: true }).then(() => {
  server.listen(PORT, () => {
    ...
    const feedbacks = [
      ...
      {title: "Impecable", staff: "Gaston Schmitz", staffId: 10, description: "Clases sublimes", score: 5},
      {title: "Gracias", staff: "Gaston Schmitz", staffId: 10, description: "Se copa bastante", score: 4},
      {title: "Keseyó", staff: "Gaston Schmitz", staffId: 10, description: "Tiene sus días", score: 3},
      {title: "tengo una keja", staff: "Gaston Schmitz", staffId: 10, description: "Flojardo", score: 2},
